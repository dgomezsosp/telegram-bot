...
exports.create = async (req, res, next) => {
  try {
    const data = await UserCredential.create(req.body)
...
exports.findAll = async (req, res, next) => {
  try {
    ...
    const result = await UserCredential.findAndCountAll({
      where: condition,
...
exports.findOne = async (req, res, next) => {
  try {
    ...
    const data = await UserCredential.findByPk(id)
...
exports.update = async (req, res, next) => {
  try {
    const id = req.params.id
    const [numberRowsAffected] = await UserCredential.update(req.body, { where: { id } })
...
exports.delete = async (req, res, next) => {
  try {
    const id = req.params.id
    const numberRowsAffected = await UserCredential.destroy({ where: { id } })
