...
class EventsFilter extends HTMLElement {
  constructor () {
    super()
        ...
        <div class="filter-modal">
          <form>
            ...
            <div class="filter-field">
              ...
              <textarea id="description" name="description" rows="3" placeholder="Describe el bot..."></textarea>
            </div>
            <div class="filter-field">
...
customElements.define('events-filter-component', EventsFilter)
