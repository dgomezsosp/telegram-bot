...
class FeaturesTitlesFilter extends HTMLElement {
  constructor () {
    super()
        ...
        <div class="filter-modal">
          <form>
            <div class="filter-field">
              <label for="title">Título característica:</label>
...
customElements.define('features-filter-component', FeaturesTitlesFilter)
