...
class SubscriptionFormsForm extends HTMLElement {
  constructor () {
    super()
            ...
            <div class="form-element-group">
              <div class="form-element">
                ...
                <div class="form-element-input">
                  <input type="text" placeholder="Nombre identificador" name="name">
                </div>
              </div>
              <div class="form-element">
                <div class="form-title">
                ...
                <div class="form-element-input">
                  <input type="text" placeholder="Título explicación" name="explanationTitle">
                </div>
              </div>
              <div class="form-element full-width">
                <div class="form-title">
                  <span>Info explicación:</span>
                </div>
                <div class="form-element-input">
                  <textarea placeholder="Info explicación..." name="explanationInfo" rows="4"></textarea>
                </div>
              </div>
              <div class="form-element">
                <div class="form-title">
                  <span>Característica explicación:</span>
                </div>
                <div class="form-element-input">
                  <input type="text" placeholder="Característica explicación" name="explanationFeatured">
                </div>
              </div>
              <div class="form-element">
                <div class="form-title">
                  <span>Título área info:</span>
                </div>
                <div class="form-element-input">
                  <input type="text" placeholder="Título área info" name="infoAreaTitle">
                </div>
              </div>
              <div class="form-element">
                <div class="form-title">
                  <span>Subtítulo área info:</span>
                </div>
                <div class="form-element-input">
                  <input type="text" placeholder="Subtítulo área info" name="infoAreaTitle">
                </div>
              </div>
              <div class="form-element">
                <div class="form-title">
                ...
                <div class="form-element-input">
                  <input type="text" placeholder="Texto botón" name="formElementButton">
                </div>
              </div>
            </div>            
          </div>
...
customElements.define('subscription-forms-form-component', SubscriptionFormsForm)
