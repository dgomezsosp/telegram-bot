...
class HeroTable extends HTMLElement {
  ...
  render () {
    ...
    this.data.rows.forEach(element => {
      ...
      buttonTextLabel.textContent = 'Texto del botón: '
      buttonTextLabel.style.fontWeight = 'bold'
      buttonText.appendChild(buttonTextLabel)
      buttonText.append(` ${element.buttonText}`)
...
customElements.define('hero-table-component', HeroTable)
