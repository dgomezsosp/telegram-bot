...
class SpotsTable extends HTMLElement {
  ...
  render () {
    ...
    this.data.rows.forEach(element => {
      ...
      adressLabel.textContent = 'Dirección: '
      adressLabel.style.fontWeight = 'bold'
      adress.appendChild(adressLabel)
      adress.append(` ${element.adress}`)
      ul.appendChild(adress)

      const environment = document.createElement('li')
      const environmentLabel = document.createElement('span')
      environmentLabel.textContent = 'Entorno: '
      environmentLabel.style.fontWeight = 'bold'
      environment.appendChild(environmentLabel)
      environment.append(` ${element.environment}`)
      ul.appendChild(environment)
...
customElements.define('spots-table-component', SpotsTable)
